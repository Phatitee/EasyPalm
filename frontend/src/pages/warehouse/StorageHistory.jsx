...
import { Search, List, Loader, ServerCrash, Inbox, Archive, Users, Truck } from 'lucide-react';
...
const StorageHistory = () => {
    ...
    const fetchStorageHistory = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetch(`http://127.0.0.1:5000/warehouse/storage-history?${params.toString()}`);
