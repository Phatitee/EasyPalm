// frontend/src/pages/purchasing/PurchaseHistoryDetail.jsx (FIXED)
...
const PurchaseHistoryDetail = ({ orderId, onClose }) => {
    ...
    useEffect(() => {
        ...
        const fetchOrderDetail = async () => {
            setLoading(true);
            try {
                // 3. ★★★ แก้ไข: เปลี่ยน fetch เป็น getPurchaseOrder ★★★
    ...
    const handlePrint = useReactToPrint({
        contentRef: printRef,
        documentTitle: `ใบเสร็จรับซื้อ-${order?.purchase_order_number || 'unknown'}`,
        onAfterPrint: () => {
